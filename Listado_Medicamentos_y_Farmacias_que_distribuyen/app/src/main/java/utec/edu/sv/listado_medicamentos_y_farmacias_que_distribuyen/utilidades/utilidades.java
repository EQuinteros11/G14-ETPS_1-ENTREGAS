...
public class utilidades {
  ...
  public static String CAMPO_PRECIO_DET ="PRECIO_DET";
  public static String CAMPO_FKID_FARM ="FKID_FARM";
  ...
  public static final String CREAR_TABLA_FARMACIA_DETALLE ="CREATE TABLE "+TABLA_FARMACIAS_DETALLE+"("+CAMPO_ID_FAR_DET+" INTEGER PRIMARY KEY AUTOINCREMENT," +
          ""+CAMPO_FK_ID_CAT_DET+" INTEGER, "+CAMPO_FK_ID_MEDICA_DET+" INTEGER,"+CAMPO_CANTIDAD_DET+" REAL, "+CAMPO_PRECIO_DET+" REAL, "+CAMPO_FKID_FARM+" INTEGER, "+
          ...
          "FOREIGN KEY("+CAMPO_FKID_FARM+") REFERENCES "+utilidades.TABLA_FARMACIAS+"("+utilidades.CAMPO_ID_FAR+") )";
