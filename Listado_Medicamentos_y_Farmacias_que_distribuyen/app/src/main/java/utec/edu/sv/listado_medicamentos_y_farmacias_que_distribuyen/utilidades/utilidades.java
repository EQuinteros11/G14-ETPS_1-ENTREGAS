...
public class utilidades {
    ...
    public static final String CREAR_TABLA_USUARIO="CREATE TABLE "+TABLA_USUARIO+"("+CAMPO_ID_USER+" TEXT PRIMARY KEY, "+CAMPO_USER_NICKNAME+" TEXT, "+CAMPO_PASS+" TEXT)";
  ...
  // CONSTANTES CAMPOS TABLA DATOS_USUARIO
    ...
    public static String CAMPO_FK_ID_USER ="ID_USER";

    public static final String CREAR_TABLA_DATOS_USUARIO="CREATE TABLE "+TABLA_DATOS_USUARIO+"("+CAMPO_ID_DU+" TEXT PRIMARY KEY," +
            " "+CAMPO_NOMBRE+" TEXT,"+CAMPO_APELLIDOS+" TEXT, "+CAMPO_EDAD+" TEXT, "+CAMPO_DIRECCION+" TEXT,"+CAMPO_CORREO+" TEXT, "+CAMPO_FK_ID_USER+" TEXT, " +
            "FOREIGN KEY("+CAMPO_FK_ID_USER+") REFERENCES "+TABLA_USUARIO+"("+CAMPO_ID_USER+"))";
    ...
    public static String TABLA_PRECIOS ="mnt_precios";
    public static String CAMPO_ID_PRECIO ="ID_PRECIO";
    public static String CAMPO_PRECIO ="PRECIO";
    public static String CAMPO_FK_ID_MEDICA ="ID_MEDICA";

    public static final String CREAR_TABLA_PRECIOS="CREATE TABLE "+TABLA_PRECIOS+"("+CAMPO_ID_PRECIO+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_PRECIO+" REAL," +
            ""+CAMPO_FK_ID_MEDICA+" INTEGER, FOREIGN KEY("+CAMPO_FK_ID_MEDICA+") REFERENCES "+TABLA_MEDICAMENTO+"("+CAMPO_ID_MEDICA+"))";
  ...
  /*--------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public static String CAMPO_FK_ID_CAT ="ID_CAT";
    ...
    public static final String CREAR_TABLA_FARMACIAS="CREATE TABLE "+TABLA_FARMACIAS+"("+CAMPO_ID_FAR+" INTEGER PRIMARY KEY AUTOINCREMENT," +
          ""+CAMPO_RASON_S+" TEXT, "+CAMPO_SUCURSAL+" TEXT,"+CAMPO_FK_ID_DIR+" INTEGER,"+CAMPO_FK_ID_CAT+" INTEGER, " +
            "FOREIGN KEY("+CAMPO_FK_ID_DIR+") REFERENCES "+TABLA_DIRECCIONES+"("+CAMPO_ID_DIR+")," +
            "FOREIGN KEY("+CAMPO_FK_ID_CAT+") REFERENCES "+TABLA_CAT_MEDICA+"("+CAMPO_ID_CAT+"))";
